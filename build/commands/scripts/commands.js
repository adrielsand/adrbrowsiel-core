...
// https://github.com/adrbrowsiel/adrbrowsiel-browser/issues/13724
...
program
  ...
  .option('--adrbrowsiel_google_api_key <adrbrowsiel_google_api_key>')
  .option('--adrbrowsiel_google_api_endpoint <adrbrowsiel_google_api_endpoint>')
  .option('--adrbrowsiel_infura_project_id <adrbrowsiel_infura_project_id>')
  ...
  .option('--adrbrowsiel_safetynet_api_key <adrbrowsiel_safetynet_api_key>')
...
program
  ...
  .option('--skip_signing', 'skip signing dmg/adrbrowsiel_installer.exe')
...
program
  ...
  .option('--disable_adrbrowsiel_extension', 'disable loading the adrbrowsiel extension')
  .option('--disable_adrbrowsiel_rewards_extension', 'disable loading the adrbrowsiel Rewards extension')
  ...
  .option('--enable_adrbrowsiel_update', 'enable adrbrowsiel update')
  ...
  // See https://github.com/adrbrowsiel/adrbrowsiel-browser/wiki/Rewards#flags for more information
  .option('--rewards [options]', 'options for rewards')
  .option('--adrbrowsiel_ads_testing', 'ads testing')
  .option('--adrbrowsiel_ads_production', 'ads production')
  .option('--adrbrowsiel_ads_staging', 'ads staging')
  .option('--adrbrowsiel_ads_debug', 'ads debug')
  .option('--single_process', 'use a single process')
  .option('--network_log', 'log network activity to network_log.json')
  .option('--output_path [pathname]', 'use the adrbrowsiel binary located at [pathname]')
  .arguments('[build_config]')
  .action(start.bind(null, parsedArgs.unknown))

program
  .command('pull_l10n')
  .option('--extension <extension>', 'Scope this command to localize a adrbrowsiel extension such as ethereum-remote-client')
