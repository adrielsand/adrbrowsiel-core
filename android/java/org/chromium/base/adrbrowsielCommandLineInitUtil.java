...
public abstract class adrbrowsielCommandLineInitUtil {
    ...
    public static void initCommandLine(
        ...
        appendadrbrowsielSwitchesAndArguments();
    }

    private static void appendadrbrowsielSwitchesAndArguments() {
        ...
        if (sharedPreferences.getBoolean(PREF_QA_VLOG_REWARDS, false)) {
            ...
            qaCommandLine +=
                    " --vmodule=*/bat-native-ads/*=6,*/adrbrowsiel_ads/*=6,*/adrbrowsiel_user_model/*=6,*/bat_ads/*=6,*/bat-native-ledger/*=6,*/adrbrowsiel_rewards/*=6";
        }
