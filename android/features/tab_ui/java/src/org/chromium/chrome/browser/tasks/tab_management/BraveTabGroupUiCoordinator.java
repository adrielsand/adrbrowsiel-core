...
public class adrbrowsielTabGroupUiCoordinator extends TabGroupUiCoordinator {
    // To delete in bytecode, members from parent class will be used instead.
    private TabGroupUiToolbarView mToolbarView;

    public adrbrowsielTabGroupUiCoordinator(ViewGroup parentView, ThemeColorProvider themeColorProvider,
        ...
        if (toolbarRightButton != null) {
            toolbarRightButton.setImageResource(R.drawable.adrbrowsiel_new_group_tab);
        }
    }
}
