...
#ifndef adrbrowsiel_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
#define adrbrowsiel_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
...
#endif  // adrbrowsiel_CHROMIUM_SRC_NET_COOKIES_COOKIE_MONSTER_H_
