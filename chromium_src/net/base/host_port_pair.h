...
#ifndef adrbrowsiel_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_
#define adrbrowsiel_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_

#include <string>

// Nudges HostPortPair past Chromium's style
// threshold for in-line constructors and destructors.
#define adrbrowsiel_HOST_PORT_PAIR_H_ \
...
#undef adrbrowsiel_HOST_PORT_PAIR_H_

#endif  // adrbrowsiel_CHROMIUM_SRC_NET_BASE_HOST_PORT_PAIR_H_
