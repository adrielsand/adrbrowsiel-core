...
#ifndef adrbrowsiel_CHROMIUM_SRC_COMPONENTS_FLAGS_UI_FLAGS_STATE_H_
#define adrbrowsiel_CHROMIUM_SRC_COMPONENTS_FLAGS_UI_FLAGS_STATE_H_
...
#endif  // adrbrowsiel_CHROMIUM_SRC_COMPONENTS_FLAGS_UI_FLAGS_STATE_H_
