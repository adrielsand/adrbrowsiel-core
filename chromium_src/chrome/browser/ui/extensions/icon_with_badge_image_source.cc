...
#define adrbrowsiel_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_1 \
  true ? ScaleImageSkiaRep(rep,                             \
                           GetCustomGraphicSize().value_or( \
                               extensions::ExtensionAction::ActionIconSize()), \
                           canvas->image_scale()) :

#define adrbrowsiel_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_2 \
...
#undef adrbrowsiel_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_2
#undef adrbrowsiel_ICON_WITH_BADGE_IMAGE_SOURCE_DRAW_1
