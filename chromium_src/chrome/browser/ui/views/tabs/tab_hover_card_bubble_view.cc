...
void TabHoverCardBubbleView_ChromiumImpl::adrbrowsielUpdateCardContent(
    const Tab* tab) {
  ...
  // Replace chrome:// with adrbrowsiel://. Since this is purely in the UI we can
