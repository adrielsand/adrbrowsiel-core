...
const char kadrbrowsielTranslateServer[] = "https://translate-relay.adrbrowsiel.com";
const char kadrbrowsielTranslateEndpoint[] = "https://translate-relay.adrbrowsiel.com/translate"; // NOLINT
const char kadrbrowsielTranslateLanguageEndpoint[] = "https://translate-relay.adrbrowsiel.com/language"; // NOLINT
const char kadrbrowsielTranslateServerPrefix[] = "https://translate-relay.adrbrowsiel.com/*"; // NOLINT
