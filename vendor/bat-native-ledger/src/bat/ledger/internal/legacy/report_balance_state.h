...
#ifndef adrbrowsielLEDGER_LEGACY_REPORT_BALANCE_STATE_H_
#define adrbrowsielLEDGER_LEGACY_REPORT_BALANCE_STATE_H_
...
#endif  // adrbrowsielLEDGER_LEGACY_REPORT_BALANCE_STATE_H_
