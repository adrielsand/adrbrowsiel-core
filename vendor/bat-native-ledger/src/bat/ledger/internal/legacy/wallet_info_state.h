...
#ifndef adrbrowsielLEDGER_LEGACY_WALLET_INFO_STATE_H_
#define adrbrowsielLEDGER_LEGACY_WALLET_INFO_STATE_H_
...
#endif  // adrbrowsielLEDGER_LEGACY_WALLET_INFO_STATE_H_
