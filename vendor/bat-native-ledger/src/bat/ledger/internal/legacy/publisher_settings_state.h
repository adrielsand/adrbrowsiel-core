...
#ifndef adrbrowsielLEDGER_LEGACY_PUBLISHER_SETTINGS_STATE_H_
#define adrbrowsielLEDGER_LEGACY_PUBLISHER_SETTINGS_STATE_H_
...
#endif  // adrbrowsielLEDGER_LEGACY_PUBLISHER_SETTINGS_STATE_H_
