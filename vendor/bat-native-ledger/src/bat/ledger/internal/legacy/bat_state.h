...
#ifndef adrbrowsielLEDGER_BAT_CLIENT_STATE_H_
#define adrbrowsielLEDGER_BAT_CLIENT_STATE_H_
...
namespace adrbrowsielledger_bat_state {
...
#endif  // adrbrowsielLEDGER_BAT_CLIENT_STATE_H_
