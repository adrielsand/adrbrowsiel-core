...
#ifndef adrbrowsielLEDGER_PUBLISHER_PREFIX_ITERATOR_H_
#define adrbrowsielLEDGER_PUBLISHER_PREFIX_ITERATOR_H_
...
#endif  // adrbrowsielLEDGER_PUBLISHER_PREFIX_ITERATOR_H_
