...
#ifndef adrbrowsielLEDGER_PROMOTION_PROMOTION_UTIL_H_
#define adrbrowsielLEDGER_PROMOTION_PROMOTION_UTIL_H_
...
#endif  // adrbrowsielLEDGER_PROMOTION_PROMOTION_UTIL_H_
