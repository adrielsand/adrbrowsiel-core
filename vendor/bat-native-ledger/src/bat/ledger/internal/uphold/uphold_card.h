...
#ifndef adrbrowsielLEDGER_UPHOLD_UPHOLD_CARD_H_
#define adrbrowsielLEDGER_UPHOLD_UPHOLD_CARD_H_
...
const char kCardName[] = "adrbrowsiel Browser";
...
#endif  // adrbrowsielLEDGER_UPHOLD_UPHOLD_CARD_H_
