...
#ifndef adrbrowsiel_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
#define adrbrowsiel_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
...
class PromotionServer {
 public:
  ...
  promotion::PostWalletadrbrowsiel* post_wallet_adrbrowsiel() const;
  ...
  promotion::PostClaimadrbrowsiel* post_claim_adrbrowsiel() const;
 ...
 private:
  ...
  std::unique_ptr<promotion::PostWalletadrbrowsiel> post_wallet_adrbrowsiel_;
  ...
  std::unique_ptr<promotion::PostClaimadrbrowsiel> post_claim_adrbrowsiel_;
...
#endif  // adrbrowsiel_VENDOR_BAT_NATIVE_LEDGER_SRC_BAT_LEDGER_INTERNAL_ENDPOINT_PROMOTION_PROMOTION_SERVER_H_
