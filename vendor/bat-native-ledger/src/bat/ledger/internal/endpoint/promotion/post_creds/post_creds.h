...
#ifndef adrbrowsielLEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
#define adrbrowsielLEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
...
#endif  // adrbrowsielLEDGER_ENDPOINT_PROMOTION_POST_CREDS_POST_CREDS_H_
