...
#ifndef adrbrowsielLEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
#define adrbrowsielLEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
...
#endif  // adrbrowsielLEDGER_ENDPOINT_PAYMENT_PAYMENT_SERVER_H_
