...
#ifndef adrbrowsielLEDGER_ENDPOINT_PAYMENT_GET_CREDENTIALS_GET_CREDENTIALS_H_
#define adrbrowsielLEDGER_ENDPOINT_PAYMENT_GET_CREDENTIALS_GET_CREDENTIALS_H_
...
#endif  // adrbrowsielLEDGER_ENDPOINT_PAYMENT_GET_CREDENTIALS_GET_CREDENTIALS_H_
