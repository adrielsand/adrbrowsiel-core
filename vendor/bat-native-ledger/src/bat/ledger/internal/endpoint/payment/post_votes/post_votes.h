...
#ifndef adrbrowsielLEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
#define adrbrowsielLEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
...
#endif  // adrbrowsielLEDGER_ENDPOINT_PAYMENT_POST_VOTES_POST_VOTES_H_
