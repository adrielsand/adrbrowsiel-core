...
#ifndef adrbrowsielLEDGER_ENDPOINT_PRIVATE_CDN_PRIVATE_CDN_SERVER_H_
#define adrbrowsielLEDGER_ENDPOINT_PRIVATE_CDN_PRIVATE_CDN_SERVER_H_
...
#endif  // adrbrowsielLEDGER_ENDPOINT_PRIVATE_CDN_PRIVATE_CDN_SERVER_H_
