...
#ifndef adrbrowsielLEDGER_DATABASE_DATABASE_PUBLISHER_PREFIX_LIST_H_
#define adrbrowsielLEDGER_DATABASE_DATABASE_PUBLISHER_PREFIX_LIST_H_
...
#endif  // adrbrowsielLEDGER_DATABASE_DATABASE_PUBLISHER_PREFIX_LIST_H_
