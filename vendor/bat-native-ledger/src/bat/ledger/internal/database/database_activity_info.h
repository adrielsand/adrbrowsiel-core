...
#ifndef adrbrowsielLEDGER_DATABASE_DATABASE_ACTIVITY_INFO_H_
#define adrbrowsielLEDGER_DATABASE_DATABASE_ACTIVITY_INFO_H_
...
#endif  // adrbrowsielLEDGER_DATABASE_DATABASE_ACTIVITY_INFO_H_
