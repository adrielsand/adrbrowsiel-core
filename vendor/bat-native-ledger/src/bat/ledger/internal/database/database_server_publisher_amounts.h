...
#ifndef adrbrowsielLEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_AMOUNTS_H_
#define adrbrowsielLEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_AMOUNTS_H_
...
#endif  // adrbrowsielLEDGER_DATABASE_DATABASE_SERVER_PUBLISHER_AMOUNTS_H_
