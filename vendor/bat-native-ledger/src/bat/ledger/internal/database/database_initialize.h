...
#ifndef adrbrowsielLEDGER_DATABASE_DATABASE_INITIALIZE_H_
#define adrbrowsielLEDGER_DATABASE_DATABASE_INITIALIZE_H_
...
#endif  // adrbrowsielLEDGER_DATABASE_DATABASE_INITIALIZE_H_
