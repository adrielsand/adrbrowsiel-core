...
#ifndef adrbrowsielLEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
#define adrbrowsielLEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
...
#endif  // adrbrowsielLEDGER_RECOVERY_RECOVERY_EMPTY_BALANCE_H_
