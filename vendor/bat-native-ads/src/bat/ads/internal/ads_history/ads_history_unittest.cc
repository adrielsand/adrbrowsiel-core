...
TEST_F(BatAdsAdsHistoryTest, AddBraveNewsAdToEmptyHistory) {
  // Arrange
  BraveNewsAdInfo ad;
...
TEST_F(BatAdsAdsHistoryTest, AddBraveNewsAdsToHistory) {
  // Arrange
  BraveNewsAdInfo ad;
...
TEST_F(BatAdsAdsHistoryTest, AddMultipleAdTypesToHistory) {
  ...
  history::AddBraveNewsAd(brave_news_ad, ConfirmationType::kViewed);
