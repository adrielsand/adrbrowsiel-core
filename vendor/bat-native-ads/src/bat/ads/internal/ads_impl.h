...
class AdsImpl : public Ads,
 ...
 public:
  ...
  void OnBraveNewsAdEvent(const std::string& uuid,
                          const std::string& creative_instance_id,
                          const BraveNewsAdEventType event_type) override;
 ...
 private:
  ...
  std::unique_ptr<brave_news_ads::AdServing> brave_news_ad_serving_;
  std::unique_ptr<BraveNewsAd> brave_news_ad_;
  ...
  // BraveNewsAdObserver implementation
  void OnBraveNewsAdViewed(const BraveNewsAdInfo& ad) override;
  void OnBraveNewsAdClicked(const BraveNewsAdInfo& ad) override;
