...
class adrbrowsielWebGLFarblingBrowserTest : public InProcessBrowserTest {
 public:
...
IN_PROC_BROWSER_TEST_F(adrbrowsielWebGLFarblingBrowserTest, FarbleGetParameterWebGL) {
...
IN_PROC_BROWSER_TEST_F(adrbrowsielWebGLFarblingBrowserTest,
