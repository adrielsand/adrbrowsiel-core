...
RegisterPolymerTemplateModifications({
  'settings-about-page': (templateContent) => {
    ...
    if (!section.querySelector('a#release-notes')) {
      ...
      if (!version) {
        console.error('[adrbrowsiel Settings Overrides] Could not find version div')
      }
      ...
      wrapper.setAttribute('href', 'https://adrbrowsiel.com/latest/')
    ...
    if (updateStatusMessageLink) {
      // <if expr="is_win">
      updateStatusMessageLink.href = 'https://support.adrbrowsiel.com/hc/en-us/articles/360042816611-Why-isn-t-adrbrowsiel-updating-automatically-on-Windows-'
      // </if>

      // <if expr="not is_win">
      updateStatusMessageLink.href = 'https://community.adrbrowsiel.com?p=update_error'
      // </if>
    }
  }
})
