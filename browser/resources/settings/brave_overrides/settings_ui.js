...
import {RegisterStyleOverride, RegisterPolymerComponentBehaviors} from 'chrome://adrbrowsiel-resources/polymer_overriding.js'

// TODO: move throttle utility to a chrome://adrbrowsiel-resources module
  ...
  html`
    <style>
      :host {
        ...
        --adrbrowsiel-settings-content-max-width: 708px;
        --adrbrowsiel-settings-menu-width: var(--settings-menu-width);
        --adrbrowsiel-settings-menu-margin: 12px;
      }
      cr-drawer {
      ...
      #left {
        /* fixed size menu */
        flex: 0 0 calc(var(--settings-menu-width) + var(--adrbrowsiel-settings-menu-margin) * 2)  !important;
      }
      #main {
        /* Take up rest of container up to a max */
        flex: 0 1 var(--adrbrowsiel-settings-content-max-width) !important;
      }
      #right {
...
const adrbrowsielClearSettingsMenuHighlightBehavior = {
  ready: function() {
...
RegisterPolymerComponentBehaviors({
  'settings-ui': [
    adrbrowsielClearSettingsMenuHighlightBehavior
  ]
})
