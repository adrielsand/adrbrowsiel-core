...
base::Optional<SkColor> MaybeGetDefaultColorForadrbrowsielLightUi(int id) {
  switch (id) {
    ...
    case adrbrowsielThemeProperties::COLOR_BOOKMARK_BAR_INSTRUCTIONS_TEXT:
    ...
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_BACKGROUND:
      return SkColorSetRGB(0xF3, 0xF3, 0xF5);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ARROW_BACKGROUND_HOVERED:
      return SkColorSetRGB(0xE3, 0xE3, 0xE3);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ARROW_NORMAL:
      return SkColorSetRGB(0x21, 0x25, 0x29);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ARROW_DISABLED:
      return SkColorSetARGB(0x8A, 0x49, 0x50, 0x57);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_BUTTON_BASE:
      return SkColorSetRGB(0x49, 0x50, 0x57);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ADD_BUTTON_DISABLED:
      return SkColorSetARGB(0X66, 0x49, 0x50, 0x57);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_BORDER:
      return SkColorSetRGB(0xD5, 0xD5, 0xDC);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_PANEL_BORDER:
      return SkColorSetARGB(0x21, 0x00, 0x00, 0x00);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ITEM_BACKGROUND:
      return SkColorSetRGB(0xE8, 0xE8, 0xE8);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ITEM_DRAG_INDICATOR_COLOR:
      return SkColorSetRGB(0x21, 0x25, 0x29);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_SEPARATOR:
      return SkColorSetRGB(0xE6, 0xE8, 0xF5);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_BACKGROUND:
      return SK_ColorWHITE;
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_HEADER_TEXT:
      return SkColorSetRGB(0x17, 0x17, 0x1F);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_ITEM_TEXT_NORMAL:
      return SkColorSetRGB(0x21, 0x25, 0x29);
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_ITEM_TEXT_HOVERED:
      return SkColorSetRGB(0xF0, 0xF2, 0xFF);
    case adrbrowsielThemeProperties::
        COLOR_SIDEBAR_ADD_BUBBLE_ITEM_TEXT_BACKGROUND_HOVERED:
      return SkColorSetRGB(0x4C, 0x54, 0xD2);
#endif
    case adrbrowsielThemeProperties::COLOR_FOR_TEST:
      return adrbrowsielThemeProperties::kLightColorForTest;
    default:
      return base::nullopt;
  }
}
...
base::Optional<SkColor> MaybeGetDefaultColorForadrbrowsielDarkUi(int id) {
  switch (id) {
    // Applies when the window is active, tabs and also tab bar everywhere
    // except active tab
    case ThemeProperties::COLOR_FRAME_ACTIVE:
    ...
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_BACKGROUND:
      return gfx::kadrbrowsielGrey800;
    case adrbrowsielThemeProperties::COLOR_SIDEBAR_ADD_BUBBLE_HEADER_TEXT:
...
#endif
    case adrbrowsielThemeProperties::COLOR_FOR_TEST:
      return adrbrowsielThemeProperties::kDarkColorForTest;
    default:
      return base::nullopt;
  }
}
...
#endif
    case adrbrowsielThemeProperties::COLOR_FOR_TEST:
      return adrbrowsielThemeProperties::kPrivateColorForTest;
    // The rest is covered by a dark-appropriate value
    default:
      return MaybeGetDefaultColorForadrbrowsielDarkUi(id);
  }
}
...
bool IsadrbrowsielThemeProperties(int id) {
  return id >= adrbrowsiel_THEME_PROPERTIES_START &&
         id <= adrbrowsiel_THEME_PROPERTIES_LAST;
}

}  // namespace adrbrowsielThemeProperties
// Returns a |nullopt| if the UI color is not handled by adrbrowsiel.
base::Optional<SkColor> MaybeGetDefaultColorForadrbrowsielUi(
  ...
  switch (dark_mode) {
    case dark_mode::adrbrowsielDarkModeType::adrbrowsiel_DARK_MODE_TYPE_LIGHT:
      return MaybeGetDefaultColorForadrbrowsielLightUi(id);
    case dark_mode::adrbrowsielDarkModeType::adrbrowsiel_DARK_MODE_TYPE_DARK:
      return MaybeGetDefaultColorForadrbrowsielDarkUi(id);
    default:
      NOTREACHED();
  }
