...
#ifndef adrbrowsiel_BROWSER_NET_adrbrowsiel_PROXYING_WEB_SOCKET_H_
#define adrbrowsiel_BROWSER_NET_adrbrowsiel_PROXYING_WEB_SOCKET_H_
...
// Ensures that all web socket requests go through adrbrowsiel network request
...
class adrbrowsielProxyingWebSocket
 ...
 public:
  ...
  using DisconnectCallback =
      base::OnceCallback<void(adrbrowsielProxyingWebSocket*)>;

  adrbrowsielProxyingWebSocket(
  ...
  ~adrbrowsielProxyingWebSocket() override;

  static adrbrowsielProxyingWebSocket* ProxyWebSocket(
 ...
 private:
  ...
  base::WeakPtrFactory<adrbrowsielProxyingWebSocket> weak_factory_{this};
  DISALLOW_COPY_AND_ASSIGN(adrbrowsielProxyingWebSocket);
};

#endif  // adrbrowsiel_BROWSER_NET_adrbrowsiel_PROXYING_WEB_SOCKET_H_
