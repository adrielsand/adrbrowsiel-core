...
#ifndef adrbrowsiel_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
#define adrbrowsiel_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
...
#endif  // adrbrowsiel_BROWSER_BINANCE_ANDROID_BINANCE_NATIVE_WORKER_H_
