...
#ifndef adrbrowsiel_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
#define adrbrowsiel_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
...
#endif  // adrbrowsiel_BROWSER_PERMISSIONS_MOCK_PERMISSION_LIFETIME_PROMPT_H_
