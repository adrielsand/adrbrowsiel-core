...
#ifndef adrbrowsiel_BROWSER_IPFS_IPFS_SERVICE_FACTORY_H_
#define adrbrowsiel_BROWSER_IPFS_IPFS_SERVICE_FACTORY_H_
...
#endif  // adrbrowsiel_BROWSER_IPFS_IPFS_SERVICE_FACTORY_H_
