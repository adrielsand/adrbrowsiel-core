...
#include "adrbrowsiel/components/webcompat_reporter/resources/grit/webcompat_reporter_generated_map.h"
...
class WebcompatReporterDOMHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  std::unique_ptr<adrbrowsiel::WebcompatReportUploader> uploader_;
...
WebcompatReporterDOMHandler::WebcompatReporterDOMHandler(
    scoped_refptr<network::SharedURLLoaderFactory> loader_factory)
    : uploader_(std::make_unique<adrbrowsiel::WebcompatReportUploader>(
