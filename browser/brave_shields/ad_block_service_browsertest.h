...
#ifndef adrbrowsiel_BROWSER_adrbrowsiel_SHIELDS_AD_BLOCK_SERVICE_BROWSERTEST_H_
#define adrbrowsiel_BROWSER_adrbrowsiel_SHIELDS_AD_BLOCK_SERVICE_BROWSERTEST_H_
...
class AdBlockServiceTest : public extensions::ExtensionBrowserTest {
 ...
 protected:
  ...
  void WaitForadrbrowsielExtensionShieldsDataReady();
};

#endif  // adrbrowsiel_BROWSER_adrbrowsiel_SHIELDS_AD_BLOCK_SERVICE_BROWSERTEST_H_
