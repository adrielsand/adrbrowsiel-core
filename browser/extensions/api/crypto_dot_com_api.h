...
#ifndef adrbrowsiel_BROWSER_EXTENSIONS_API_CRYPTO_DOT_COM_API_H_
#define adrbrowsiel_BROWSER_EXTENSIONS_API_CRYPTO_DOT_COM_API_H_
...
#endif  // adrbrowsiel_BROWSER_EXTENSIONS_API_CRYPTO_DOT_COM_API_H_
