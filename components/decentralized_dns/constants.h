...
#ifndef adrbrowsiel_COMPONENTS_DECENTRALIZED_DNS_CONSTANTS_H_
#define adrbrowsiel_COMPONENTS_DECENTRALIZED_DNS_CONSTANTS_H_
...
#endif  // adrbrowsiel_COMPONENTS_DECENTRALIZED_DNS_CONSTANTS_H_
