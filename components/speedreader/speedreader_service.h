...
#ifndef adrbrowsiel_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
#define adrbrowsiel_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
...
#endif  // adrbrowsiel_COMPONENTS_SPEEDREADER_SPEEDREADER_SERVICE_H_
