...
import { getUnpaddedAsDataUrl } from '../../adrbrowsiel_extension/extension/adrbrowsiel_extension/background/today/privateCDN'
import getFTXStorybookState from '../widgets/ftx/ftx_storybook_state'

// @ts-ignore
window.adrbrowsielStorybookUnpadUrl = async function UnpadUrl (paddedUrl: string, mimeType = 'image/jpg'): Promise<string> {
