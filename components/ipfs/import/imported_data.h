...
#ifndef adrbrowsiel_COMPONENTS_IPFS_IMPORT_IMPORTED_DATA_H_
#define adrbrowsiel_COMPONENTS_IPFS_IMPORT_IMPORTED_DATA_H_
...
#endif  // adrbrowsiel_COMPONENTS_IPFS_IMPORT_IMPORTED_DATA_H_
