...
#ifndef adrbrowsiel_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
#define adrbrowsiel_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
...
#endif  // adrbrowsiel_COMPONENTS_IPFS_IMPORT_IPFS_LINK_IMPORT_WORKER_H_
