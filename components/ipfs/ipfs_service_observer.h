...
#ifndef adrbrowsiel_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
#define adrbrowsiel_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
...
#endif  // adrbrowsiel_COMPONENTS_IPFS_IPFS_SERVICE_OBSERVER_H_
