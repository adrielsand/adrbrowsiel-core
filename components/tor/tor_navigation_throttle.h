...
#ifndef adrbrowsiel_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
#define adrbrowsiel_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
...
#endif  // adrbrowsiel_COMPONENTS_TOR_TOR_NAVIGATION_THROTTLE_H_
