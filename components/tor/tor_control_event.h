...
#ifndef adrbrowsiel_COMPONENTS_TOR_TOR_CONTROL_EVENT_H_
#define adrbrowsiel_COMPONENTS_TOR_TOR_CONTROL_EVENT_H_
...
#endif  // adrbrowsiel_COMPONENTS_TOR_TOR_CONTROL_EVENT_H_
