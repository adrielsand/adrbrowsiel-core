...
import { SettingsMenu } from '../../../../components/adrbrowsiel_new_tab_ui/components/default'
import Settings, { Props } from '../../../../components/adrbrowsiel_new_tab_ui/containers/newTab/settings'
