...
#ifndef adrbrowsiel_COMPONENTS_adrbrowsiel_PROCHLO_adrbrowsiel_PROCHLO_MESSAGE_H_
#define adrbrowsiel_COMPONENTS_adrbrowsiel_PROCHLO_adrbrowsiel_PROCHLO_MESSAGE_H_

#include <cstdint>
#include <string>
#include "base/time/time.h"

namespace adrbrowsiel_pyxis {
class PyxisMessage;
class RawP3AValue;
}
...
void GenerateProchloMessage(uint64_t metric_hash,
                            ...
                            adrbrowsiel_pyxis::PyxisMessage* prochlo_message);
...
#endif  // adrbrowsiel_COMPONENTS_adrbrowsiel_PROCHLO_adrbrowsiel_PROCHLO_MESSAGE_H_
