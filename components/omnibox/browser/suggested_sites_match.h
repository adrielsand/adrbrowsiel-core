...
#ifndef adrbrowsiel_COMPONENTS_OMNIBOX_BROWSER_SUGGESTED_SITES_MATCH_H_
#define adrbrowsiel_COMPONENTS_OMNIBOX_BROWSER_SUGGESTED_SITES_MATCH_H_
...
#endif  // adrbrowsiel_COMPONENTS_OMNIBOX_BROWSER_SUGGESTED_SITES_MATCH_H_
