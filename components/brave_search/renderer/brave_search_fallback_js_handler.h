...
// TODO: rename this to BraveSearchFallbackJSHandler
class BraveSearchFallbackJSHandler {
 public:
  BraveSearchFallbackJSHandler(v8::Local<v8::Context> v8_context,
                       blink::ThreadSafeBrowserInterfaceBrokerProxy* broker);
  BraveSearchFallbackJSHandler(const BraveSearchFallbackJSHandler&) = delete;
  BraveSearchFallbackJSHandler& operator=(const BraveSearchFallbackJSHandler&) = delete;
