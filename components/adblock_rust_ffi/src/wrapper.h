...
#ifndef adrbrowsiel_COMPONENTS_ADBLOCK_RUST_FFI_SRC_WRAPPER_H_
#define adrbrowsiel_COMPONENTS_ADBLOCK_RUST_FFI_SRC_WRAPPER_H_
#include <memory>
#include <string>
#include <vector>
...
#endif  // adrbrowsiel_COMPONENTS_ADBLOCK_RUST_FFI_SRC_WRAPPER_H_
