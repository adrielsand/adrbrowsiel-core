...
import { Anchor } from 'adrbrowsiel-ui/old'
    ...
    if (torrent) {
      ...
      return (
        <div className='footerNotice'>
          Privacy Warning: When you click "Start Torrent" adrbrowsiel will begin
          ...
          public IP address.
          <br /><br />
          The WebTorrent extension can be disabled from adrbrowsiel settings.
        </div>
      )
    }
  }
