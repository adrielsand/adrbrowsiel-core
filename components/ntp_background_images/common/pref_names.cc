...
const char kBrandedWallpaperNotificationDismissed[] =
    "adrbrowsiel.branded_wallpaper_notification_dismissed";
const char kNewTabPageShowSponsoredImagesBackgroundImage[] =
    "adrbrowsiel.new_tab_page.show_branded_background_image";
const char kNewTabPageSuperReferralThemesOption[] =
    "adrbrowsiel.new_tab_page.super_referral_themes_option";
const char kNewTabPageShowBackgroundImage[] =
    "adrbrowsiel.new_tab_page.show_background_image";

const char kNewTabPageCachedSuperReferralComponentInfo[] =
    "adrbrowsiel.new_tab_page.cached_super_referral_component_info";
const char kNewTabPageCachedSuperReferralComponentData[] =
    "adrbrowsiel.new_tab_page.cached_super_referral_component_data";
const char kNewTabPageGetInitialSRComponentInProgress[] =
    "adrbrowsiel.new_tab_page.get_initial_sr_component_in_progress";
const char kNewTabPageCachedSuperReferralCode[] =
    "adrbrowsiel.new_tab_page.cached_referral_code";
